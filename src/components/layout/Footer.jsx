  ...
  return (
    <footer className="bg-[#0f172a] border-t border-[#1e293b] py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-[#94a3b8] text-sm mt-2">
              © {currentYear} Areesha Khan. All rights reserved.
            </p>
          </div>
        ...
        {/* MADE WITH LOVE */}
        <div className="text-center mt-8 pt-8 border-t border-[#1e293b]">
          <p className="text-[#94a3b8] text-sm">
            Made with <span className="text-[#ec4899]">❤</span> by Areesha Khan
          </p>
        </div>
      </div>
    </footer>
